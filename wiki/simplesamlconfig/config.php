...
$config = [
     ...
     */
    'technicalcontact_name' => 'Emil Babayev',
    'technicalcontact_email' => 'emil.babayev@scouterna.se',
     ...
     */
    'secretsalt' => getenv('SAML_SECRET_SALT'),
     ...
     */
    'auth.adminpassword' => getenv('SAML_ADMIN_PASSWORD'),
