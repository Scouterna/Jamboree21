...
function Wisetable() {
  ...
  function getCategory(params) {
    if (params.row.accounting_category_override === "") {
      return params.row.accounting_category;
    } else {
      return params.row.accounting_category_override;
    }
  }
  ...
  const columns = [
    ...
    { field: "unit_name", headerName: "Avdelning", type: "string" },
    ...
    {
      field: "admin_note",
      headerName: "Admin Notering",
      type: "string",
      editable: true,
    },
    {
      field: "accounting_category",
      headerName: "Kategori (auto bokföring)",
      type: "singleSelect",
      valueOptions: [
        "4230 Resor",
        "4240 Kost",
    ...
    {
      field: "accounting_category_override",
